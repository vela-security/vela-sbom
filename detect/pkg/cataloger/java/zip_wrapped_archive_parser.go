...
import (
	...
	"github.com/vela-security/vela-sbom/internal/file"
...
// TODO: when the generic archive cataloger is implemented, this should be removed (https://github.com/vela-security/vela-sbom/issues/246)
